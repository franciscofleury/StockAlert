...
{
    public class B3Monitor_TwoWorkersTests
    {
        ...
        public class InfrastructureTest : IVersion
        {
            public static HostApplicationBuilder GenerateApplicationBuilder(Parameters alertParams)
            {
                ...
                builder.Services.AddSingleton(new AlertQueue(100));
        ...
        public class BrapiProviderTest : IVersion
        {
            public static HostApplicationBuilder GenerateApplicationBuilder(Parameters alertParams)
            {
        ...
        public class MqttProviderTest : IVersion
        {
            public static HostApplicationBuilder GenerateApplicationBuilder(Parameters alertParams)
            {
